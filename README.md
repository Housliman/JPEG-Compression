...
```bash
git clone https://github.com/your-username/jpeg-compression-visualizer.git
cd jpeg-compression-visualizer
```
...
### 1. Cloner le dépôt
```bash
git clone https://github.com/votre-nom-d-utilisateur/jpeg-compression-visualizer.git
cd jpeg-compression-visualizer
```
